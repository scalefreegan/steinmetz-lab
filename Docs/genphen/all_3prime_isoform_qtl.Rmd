...
Here is the code to compute isoforma QTLs. This takes a day or two to run. To save time, I will load directly from file. 
...
Here I just load the QTLs directly from file to save time.
...
In the 3' isoform data from Chenchen (SxY) there are among `r qtl_genes < 0.05` at an FDR of 5%. 

The majority, out of are *cis*-QTLs (i.e. within 5kb of the 3'-UTR itself)

## Plot an example gene

As an example, we will look at the QTLs detected for gene.
